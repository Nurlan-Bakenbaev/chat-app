...
const Search = () => {
 ...
 await updateDoc(currentUserChatsRef, currentUserChatsData);
 await updateDoc(otherUserChatsRef, otherUserChatsData);
} catch (err) {
