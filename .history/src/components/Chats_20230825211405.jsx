...
export default Chats;
Please note that the actual data structure and paths in your Firestore database may vary based on your implementation. The code above assumes that the chats collection is nested under the userChats document using the currentUser.uid, and that each chat object has a messages array containing individual messages.

Make sure you adapt the code to your specific data structure and paths. Additionally, remember to implement proper security rules in your Firebase project to control who can delete messages.
